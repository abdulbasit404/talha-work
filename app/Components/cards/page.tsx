...
const page: React.FC<CardProps> = ({
  ...
  return (
    <div className="bg-white flex flex-col justify-center gap-3 p-2 shadow-lg rounded-md w-full">
      ...
      <div className="flex justify-center items-center">
        <div className="flex items-center gap-2">
          <button className="bg-blue-500 text-white px-4 py-1 rounded-md">Apply Now</button>
