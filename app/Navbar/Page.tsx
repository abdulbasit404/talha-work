...
function Page() {
  ...
  return (
    <>
      <div className="bg-white flex justify-between items-center shadow-lg px-8 py-1">
        <div className="">
        ...
        <div className="hidden xl:flex xl:gap-4">
          {links.map((e) => (
            <Link
              ...
              href={e.href}
              className={
                pathName === e.href ? " text-blue-700" : "text-gray-700"
              }
            >
              {e.label}
            </Link>
        ...
        <div className=" gap-3 hidden sm:flex">
          ...
          <button className="bg-blue-800 py-3 rounded-md text-white px-4">
            Resume Builder
          </button>
          <Image
            src="/user-logo.png"
      ...
      {navbar && (
        <div className=" bg-white shadow-md flex flex-col gap-5 py-5 w-full top-17 text-center p-10">
          ...
          <div className="flex gap-2 sm:hidden">
            <button className="w-full bg-blue-800 rounded-md text-white px-4 py-3">
              Resume Builder
            </button>
            <Image
              src="/user-logo.png"
